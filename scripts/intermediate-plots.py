...
def initialise_cnn():
    exoplanets = stella.FlareDataSet(fn_dir='/Users/azib/Documents/open_source/nets2/models/exoplanets1k/',
                         catalog='/Users/azib/Documents/open_source/nets2/catalogs/exoplanets1k.txt',cadences=168,training=0.8,validation=0.1,frac_balance=1)
    fbinaries = stella.FlareDataSet(fn_dir='/Users/azib/Documents/open_source/nets2/models/binaries1k/',
                         catalog='/Users/azib/Documents/open_source/nets2/catalogs/fakebinaries1k.txt',cadences=168,training=0.8,validation=0.1,frac_balance=1)
...
def process_file(file, cnn,modelname='/Users/azib/Documents/open_source/nets2/cnn-models/ensemble_s0002_i0200_b0.7.h5'):
    try:
...
def main():
    ...
    args_list = [(base_dir, skew, duration, cnn) for skew, duration in product(skew_values, duration_values)]
    ...
    plt.imshow(recovery_grid * 100, 
               extent=[skew_values[0] - 0.5, skew_values[-1] + 0.5, duration_values[0], duration_values[-1]], 
