...
Since this package is repurposed ant not gone through the official channels, the best way to install it is:
...
The `env.yml` file above is for Apple Silicon machines (M1 or newer). If you are using Linux, use `env-linux.yml` to create your environment instead.
